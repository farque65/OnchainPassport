  ...
  return (
    <div className="w-full flex flex-col items-center justify-center">
      ...
      <div className="px-10 mb-56">
        <div className="text-center mb-4">
          <h1 className="sm:text-3xl text-2xl font-medium title-font text-gray-900 underline">Passports List</h1>
        </div>
        {/* User has a passport */}
...
export default Web3Consumer(passportauth);
